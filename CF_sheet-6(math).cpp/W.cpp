...
void solve(){
    ll x1,x2,y1,y2,cx1,cx2,cy1,cy2;
    cin >> x1>>y1>>x2>>y2>>cx1>>cy1>>cx2>>cy2;
    double o1,o2,co1,co2,r1,cr1,s;
    o1=(x1+x2)/2.0;
    o2=(y1+y2)/2.0;
    co1=(cx1+cx2)/2.0;
    co2=(cy1+cy2)/2.0;
    s=sqrt((o1-co1)*(o1-co1)+(o2-co2)*(o2-co2));
    r1=sqrt((o1-x1)*(o1-x1)+(o2-y1)*(o2-y1));
    cr1=sqrt((co1-cx1)*(co1-cx1)+(co2-cy1)*(co2-cy1));
    if(s<=(r1+cr1))     YES;
    else    NO;
}
